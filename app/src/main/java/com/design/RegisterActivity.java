...
import com.design.camera.CameraHandler;
import com.design.camera.CameraImageBean;
import com.design.camera.CameraUtil;
import com.design.camera.RequestCodes;
...
import static com.design.camera.RequestCodes.TAKE_PHOTO;
import static com.design.utils.ToastUtil.toast;

public class RegisterActivity extends AppCompatActivity {

    private TextView tv_register_title;//标题
    ...
    private void init() {
        ...
        tv_register_title = findViewById(R.id.tv_login_title);
        tv_register_title.setText("用户注册");
        tv_back = findViewById(R.id.tv_back);
        //布局根元素
        rl_title_bar = findViewById(R.id.login_title_bar);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == TAKE_PHOTO) {
                ...
                imagePath = FileUtils.getPath(this, cropUri);
                Glide.with(this).load(cropUri).apply(MConstants.OPTIONS).into(avatar);
